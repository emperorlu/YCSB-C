...
typedef struct {
    ...
    atomic_uint64_t min_;
    atomic_uint64_t max_;
    atomic_uint64_t num_;
    atomic_uint64_t sum_;
    atomic_uint64_t sum_squares_;
    atomic_uint64_t buckets_[MAX_MAP_SIZE]; // 109==BucketMapper::BucketCount()
